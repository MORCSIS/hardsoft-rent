...
// Consulta para lista de código de barras del almacén que entrega
...
$sqltransac = "SELECT DISTINCT *  FROM transacciones TR 
where TR.id_transaccion = $id_transaccion";
...
<!-- Esta tabla muestra el detalle del CLIENTE QUE RECIBE -->

    <H3>Detalle del cliente que entrega</H3>
    <table> 
        <thead>
            <tr>
            <th>ID Cliente</th>
